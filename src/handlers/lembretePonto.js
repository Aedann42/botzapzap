...
// IDs dos GRUPOS para envio único do lembrete, habilite a linha de DEBUG ID GRUPO para coletar o id dos grupos
...
const GRUPOS_LEMBRETE = [
    ...
    "553299534821-1631393267@g.us", // Equipe 300 ( interior)
    "553299447210-1436528709@g.us" //Execução BQ
];

// Array com frases bem-humoradas para cada horário
const FRASES_LEMBRETE = {
    '7:55': [
        "Lembre-se de registrar sua entrada no ponto antes de começar suas atividades. Esse registro é importante para o controle correto da jornada "
    ],
    '12:00': [
        "Bateu a fome? 😋 Lembre-se de registrar o início do seu intervalo antes de aproveitar o almoço! "
    ],
    '17:45': [
        "Fim do dia chegando! Antes de ir, não esqueça de registrar sua saída no ponto. Assim mantemos tudo certinho. "
        ]
};
/**
 * Seleciona uma frase aleatória para o horário especificado.
 * @param {string} horario - '7:55', '12:00', '17:45'.
 * @returns {string} Mensagem de lembrete formatada.
 */
function escolherMensagem(horario) {
    const frases = FRASES_LEMBRETE[horario];
    if (!frases || frases.length === 0) {
        return `Atenção! Lembrete de ponto!`;
    }
